<?php
/*
Widget Name: NetBaseTeam Headline
Description: NetBaseTeam A headline to headline all headlines.
Author: NetBaseTeam
Author URI: http://netbaseteam.com/
*/

class WpNetbase_SiteOrigin_Headline_Widget extends SiteOrigin_Widget {

	function __construct() {
		parent::__construct(
			'wpnetbase-sow-headline',
			__('NBT SiteOrigin Headline', 'addon-so-widgets-bundle'),
			
			array(
				'description' => __('NetBaseTeam A headline widget.', 'addon-so-widgets-bundle'),
				...
				'fields' => array(
					...
					'tag' => array(
						...
						'options' => array(
							...
							'div' => __( 'Paragraph', 'so-widgets-bundle' ),
						)
					),
					'color' => array(
						'type' => 'color',
...
siteorigin_widget_register('wpnetbase-sow-headline', __FILE__, 'WpNetbase_SiteOrigin_Headline_Widget');
