<?php
class wpnetbase_author_widget extends WP_Widget {

	function __construct() {
		parent::__construct(
		/*Base ID of your widget*/ 
		'wpnetbase_author_widget', 

		/*Widget name will appear in UI*/ 
		__('NBT author widget', 'wpb_widget_domain'), 

		/*Widget description*/ 
		array( 'description' => __( 'A widget that displays the post author information.', 'wpb_widget_domain' ),  'panels_groups' => array('netbaseteam') ) 
		);
	}
    /**
...
function wpnetbase_load_author_widget() 
{
	register_widget( 'wpnetbase_author_widget' );
}
add_action( 'widgets_init', 'wpnetbase_load_author_widget' );
?>