...
$header_default_position = isset($woopanel_dokan_store->data['header_default_position']) ? $woopanel_dokan_store->data['header_default_position'] : 'left';
...
<div class="profile-frame<?php echo esc_attr( $no_banner_class ); ?>">
    ...
    <div class="profile-info-box profile-layout-<?php echo esc_attr( $profile_layout ); ?>">
        ...
        <div class="profile-info-summery-wrapper profile-info-<?php echo esc_attr($header_default_position);?>-summery dokan-clearfix">
            <div class="profile-info-summery">
                <div class="profile-info-head">
                    <div class="profile-img <?php echo esc_attr( $profile_img_class ); ?>">
                        <img src="<?php echo esc_url( $store_user->get_avatar() ) ?>"
                            alt="<?php echo esc_attr( $store_user->get_shop_name() ) ?>"
                            size="150" style="margin: 0 auto;">
                    </div>
                    ...
                    <ul class="dokan-store-info">
                        <?php if ( isset( $store_address ) && !empty( $store_address ) ) { ?>
                            <li class="dokan-store-address"><i class="fa fa-map-marker"></i>
                                <?php echo wp_kses($store_address, array(
                                    'span' => array(
                                        'class' => array()
                                    )
                                )); ?>
...
<?php do_action( 'woopanel_header_after', $woopanel_dokan_store, $store_tabs, isset($query) ? $query : array() );?>