	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		...
		<textarea rows="4" class="woocommerce-Input woocommerce-Input--text input-text" name="account_address" id="account_address"><?php echo esc_attr( $my_account['address'] ); ?></textarea>
	</p>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		<label for="account_country"><?php esc_html_e( 'Country / Region', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
		<select name="account_country" style="<?php echo esc_attr( $value['css'] ); ?>" data-placeholder="<?php esc_attr_e( 'Choose a country / region&hellip;', 'woocommerce' ); ?>" aria-label="<?php esc_attr_e( 'Country / Region', 'woocommerce' ); ?>" class="wc-enhanced-select">
