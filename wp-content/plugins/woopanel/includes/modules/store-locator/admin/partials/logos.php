    ...
    <div class="row asl-inner-cont">
      <div class="col-md-12">
        <div class="card p-0 mb-4">
          <h3 class="card-title"><?php echo esc_html__('Manage Logos','asl_admin') ?></h3>
          <div class="card-body">
            <?php if(!is_writable(WOOPANEL_STORE_LOCATOR_PATH.'public/icon')): ?>
              <h3  class="alert alert-danger" style="font-size: 14px"><?php echo WOOPANEL_STORE_LOCATOR_PATH.'public/icon' ?> <= <?php echo esc_html__('Directory is not writable, Logo Image Upload will Fail, Make directory writable.','asl_admin') ?></h3>  
            <?php endif; ?>
            <div class="row mb-3">
              <div class="col-md-12 ralign">
                ...
                <button type="button" id="btn-asl-new-c" class="btn disabled btn-primary mrg-r-10"><i><svg width="13" height="13"><use xlink:href="#i-plus"></use></svg></i><?php echo esc_html__('New Logo','asl_admin') ?></button>
              </div>
            </div>
            <table id="tbl_logos" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th align="center"><input type="text" class="form-control" data-id="name"  placeholder="<?php echo esc_html__('Search Name','asl_admin') ?>"  /></th>
                    <th align="center">&nbsp;</th>
                    <th align="center">&nbsp;</th>
                  </tr>
                  <tr>
                    <th align="center"><a class="select-all"><?php echo esc_html__('Select All','asl_admin') ?></a></th>
                    <th align="center"><?php echo esc_html__('Logo ID','asl_admin') ?></th>
                    <th align="center"><?php echo esc_html__('Name','asl_admin') ?></th>
                    <th align="center"><?php echo esc_html__('Image','asl_admin') ?></th>
    ...
    <div class="smodal-dialog" role="document">
      <div class="smodal-content">
        <div class="smodal-header">
          <h5 class="smodal-title"><?php echo esc_html__('Update Logo','asl_admin') ?></h5>
        ...
        <div class="smodal-body">
          ...
          <div class="row">
            <div class="col-md-12 form-group mb-3">
                  <label class="control-label"><?php echo esc_html__('Logo ID','asl_admin') ?></label>
          ...
          <div class="smodal-footer">
            <button class="btn disabled btn-primary btn-start mrg-r-15" id="btn-asl-update-logos"   type="button" data-loading-text="<?php echo esc_html__('Submitting ...','asl_admin') ?>"><?php echo esc_html__('Update Logo','asl_admin') ?></button>
  ...
  <div class="smodal-dialog" role="document">
      <div class="smodal-content">
        ...
        <div class="smodal-footer">
          ...
          <button type="button" class="btn disabled btn-secondary" data-dismiss="smodal"><?php echo esc_html__('Close','asl_admin') ?></button>
        </div>
        </form>
      </div>
    </div>
