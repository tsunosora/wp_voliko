...
$attribute_four = woopanel_price_matrix_attribute_label($_pm_attr['horizontal'][1], $product_id, $order_attributes);
?>
    ...
    <table class="pure-table price-matrix-table vertical-3">
        <tbody>
            ...
            <tr>
                ...
                <td class="attr-name heading-center" colspan="<?php echo count($attribute_three);?>"><?php echo esc_attr($attr_three->name);?></td>
                <?php endforeach;?>
            </tr>
            <?php
            end($attribute_three);
...
/* 
                    ...
                    ?>
                    <td class="price" data-attr="<?php echo htmlspecialchars(wp_json_encode( $group_attr ));?>"><div class="wrap"><div class="zone-edit" contenteditable="false"><?php echo woopanel_price_matrix_attribute_price($group_attr, $product, true);?></div></div></td>
                    <?php endforeach;
                    endforeach;?>
                </tr>
                <?php endforeach;
