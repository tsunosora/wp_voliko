...
Make customers easily purchase products through WhatsApp with a single click and increase your sales.
...
### **Premium Add-on(s)**
* [**OneClick WCFM Connector**](https://onlinestorekit.com/oneclick-wcfm-connector/): Seamlessly combine the power of WordPress & WooCommerce, OneClick Chat to Order, WCFM Marketplace Multivendor, WCFM Frontend Manager and WhatsApp.
...
* **NEW!: Option to include coupon code in the Checkout page** (that will include coupon code details in the message)
...
> For more info, please refer to [this page](https://www.seniberpikir.com/oneclick-whatsapp-order-woocommerce/) for Indonesian users or on [this page](https://walterpinem.me/projects/oneclick-chat-to-order/) and [Online Store Kit](https://onlinestorekit.com/oneclick-chat-to-order/) for international users.
...
= How to install and use OneClick Chat to Order? =
1. Make sure your site has WooCommerce installed and activated.
2. Install and activate this plugin via dashboard or file manager.
3. Begin configurating this plugin through OneClick Chat to Order admin menu.
4. Complete the configuration and you're all set!

[**Watch Tutorial**](https://www.youtube.com/watch?v=LuURM5vZyB8 "OneClick Chat to Order Tutorial") to help you get started.

= Can I use more than one WhatsApp number? =
Of course you can! Now, you can set and use unlimited WhatsApp numbers.

[**Learn more**](https://walterpinem.me/projects/oneclick-chat-to-order-mutiple-numbers-feature/) or [**watch tutorial**](https://www.youtube.com/watch?v=TSBsxEdiNuA)

= Can I use it with 3rd party Multivendor plugins? =
As for now, this plugin is not natively compatible with any other 3rd party Multivendor plugins.

= Do I have the options to display the WhatsApp button on specific page only? =
You have! There are fully functional options to let you decide on what pages you'd like to display the WhatsApp button, whether on single product page, cart, shop loop, checkout, floating, or even show it anywhere using the Shortcode Generator feature.

= Can I show WhatsApp button only on mobile devices? =
Of course! You are just one click away to show the button only on mobile devices.

= Does this plugin compatible with latest WooCommerce version? =
This plugin will regularly be updated to make sure its compatibility.

= Where can I ask another question? =
You will get answers to many of your questions on my [contact form](https://walterpinem.me/projects/contact/). Just ask!
