jQuery(document).ready(function($) {
    'use strict';
    var this_obj = printing_press_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.printing-press-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message printing-press-plugin-install');
                button.addClass('button-primary printing-press-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.printing-press-recommended-plugins .printing-press-activation-note').css('display','block');
    ...
    $(document).on('click', '.printing-press-plugin-activate', function(event) {
