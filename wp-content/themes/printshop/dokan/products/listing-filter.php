...
<?php do_action( 'dokan_product_listing_filter_before_form' ); ?>
    ...
    <form class="dokan-form-inline dokan-w6" method="get" >
        ...
        <button type="submit" name="product_listing_filter" value="ok" class="dokan-btn dokan-btn-theme"><?php _e( 'Filter', 'printshop'); ?></button>
    ...
    <form method="get" class="dokan-form-inline dokan-w6">
        ...
        <button type="submit" name="product_listing_search" value="ok" class="dokan-btn dokan-btn-theme dokan-right"><?php _e( 'Search', 'printshop'); ?></button>

        <?php wp_nonce_field( 'dokan_product_search', 'dokan_product_search_nonce' ); ?>

        <div class="dokan-form-group dokan-right">
            <input type="text" class="dokan-form-control" name="product_search_name" placeholder="<?php _e( 'Search Products', 'printshop' ) ?>" value="<?php echo isset( $_GET['product_search_name'] ) ? $_GET['product_search_name'] : '' ?>">
        </div>
