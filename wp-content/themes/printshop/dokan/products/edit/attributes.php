<h4><?php _e( 'Attributes', 'printshop' ); ?> <small><?php _e( 'Different types of this product (e.g. size, color)', 'printshop' ); ?></small></h4>
            ...
            <div class="inputs-box woocommerce_attribute" data-count="<?php echo $i; ?>">
                ...
                <div class="box-header">
                    ...
                    <?php } else { ?>
                        ...
                        <input type="text" class="category-name" placeholder="<?php esc_attr_e( 'Category name', 'printshop' ); ?>" name="attribute_names[<?php echo $i; ?>]" value="<?php echo esc_attr( $attribute_name ); ?>">
                    ...
                    <span class="actions">
                        <button class="row-remove btn pull-right btn-danger btn-sm"><?php _e( 'Remove', 'printshop' ); ?></button>
                    </span>
                </div>
                        ...
                        <ul class="list-unstyled ">
                            <li>
                                <label class="checkbox-inline">
                                    ...
                                    ?> name="attribute_visibility[<?php echo $i; ?>]" value="1" /> <?php _e( 'Visible on the product page', 'printshop' ); ?>
                                </label>
                            </li>
                            ...
                            ?> name="attribute_variation[<?php echo $i; ?>]" value="1" /> <?php _e( 'Used for variations', 'printshop' ); ?></label>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="option-couplet list-unstyled ">
                            ...
                            if ($options) {
                                foreach ($options as $count => $option) {
                                    ...
                                    <li>
                                        <input type="text" class="option" placeholder="<?php _e( 'Option...', 'printshop' ); ?>" name="attribute_values[<?php echo $i; ?>][<?php echo $count; ?>]" value="<?php echo esc_attr( $option ); ?>">
                                ...
                                <li>
                                    <input type="text" class="option" name="attribute_values[<?php echo $i; ?>][0]" placeholder="<?php _e( 'Option...', 'printshop' ); ?>">
...
<p class="toolbar pull-right">
    ...
    <select class="select-attribute form-control" name="category_names" >
        <option value=""><?php _e( 'Custom Attribute', 'printshop' ); ?></option>
        <?php
    ...
    <button class="btn btn-success add-variant-category"><?php _e( '+ Add a category', 'printshop' ); ?></button>
    <button type="button" class="btn btn-default save_attributes" data-id="<?php echo $thepostid; ?>"><?php _e( 'Save attributes', 'printshop' ); ?></button>
</p>