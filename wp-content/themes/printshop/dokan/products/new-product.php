    ...
    <div class="dokan-dashboard-content">
        ...
        <header class="dokan-dashboard-header dokan-clearfix">
            <h1 class="entry-title">
                <?php _e( 'Add New Product', 'printshop' ); ?>
            </h1>
        </header><!-- .entry-header -->
                ...
                if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                    ...
                    <form class="dokan-form-container" method="post">
                        ...
                        <div class="row product-edit-container dokan-clearfix">
                            <div class="content-half-part featured-image">
                                <div class="dokan-feat-image-upload">
                                    <div class="instruction-inside">
                                        ...
                                        <a href="#" class="dokan-feat-image-btn dokan-btn"><?php _e( 'Upload Product Image', 'printshop' ); ?></a>
                                    </div>
                            ...
                            <div class="content-half-part dokan-product-meta">
                                <div class="dokan-form-group">
                                    <input class="dokan-form-control" name="post_title" id="post-title" type="text" placeholder="<?php esc_attr_e( 'Product name..', 'printshop' ); ?>" value="<?php echo dokan_posted_input( 'post_title' ); ?>">
                                </div>
                                ...
                                <div class="dokan-form-group">
                                    <textarea name="post_excerpt" id="post-excerpt" rows="5" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Short description of the product...', 'printshop' ); ?>"><?php echo dokan_posted_textarea( 'post_excerpt' ); ?></textarea>
                                </div>
                        ...
                        <div class="dokan-form-group">
                            ...
                            <input type="submit" name="add_product" class="dokan-btn dokan-btn-danger dokan-btn-theme" value="<?php esc_attr_e( 'Add Product', 'printshop' ); ?>"/>
                        </div>
