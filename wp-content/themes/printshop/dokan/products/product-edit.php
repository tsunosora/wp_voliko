...
if ( class_exists( 'Dokan_Product_Subscription' ) ) {
    if ( get_user_meta( $seller_id, 'product_no_with_pack', true ) ) {
        if ( get_user_meta( $seller_id, 'product_no_with_pack', true ) <= count( get_posts( array( 'post_author' => $seller_id, 'post_type' => 'product', 'posts_per_page' => -1 ) ) ) || 'publish' != $post->post_status ) {
            wp_die( __( 'Access Denied! You have reached the limit of your subscribed total online product', 'printshop' ) );
        }
    }
}
                ...
                <div class="dokan-product-edit-area">
                    ...
                    <header class="dokan-pro-edit-breadcrumb">
                        <h1 class="dokan-header-crumb">
                            <span class="dokan-breadcrumb"><a href="<?php echo dokan_get_navigation_url( 'products' ) ?>"><?php _e( 'Products', 'printshop' ); ?></a> &rarr; </span>
                            <?php echo $post->post_title; ?>

                            <?php if ( $_visibility == 'hidden' ) { ?>
                                <span class="dokan-label dokan-label-default"><?php _e( 'Hidden', 'printshop' ); ?></span>
                            <?php } ?>

                            <?php if ( $post->post_status == 'publish' ) { ?>
                                <span class="dokan-right">
                                    <a class="view-product dokan-btn dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php _e( 'View Product', 'printshop' ); ?></a>
                                </span>
                            <?php } ?>
                        </h1>
                    </header>
                                ...
                                <div class="dokan-product-edit-left">
                                    ...
                                    <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                                        <div class="dokan-message">
                                            ...
                                            <strong><?php _e( 'Success!', 'printshop' ); ?></strong> <?php _e( 'The product has been updated successfully.', 'printshop' ); ?>
                                    ...
                                    <div id="tab-container" class='tab-container'> <!-- Only required for left/right tabs -->
                                        ...
                                        <ul class="dokan_tabs">
                                            ...
                                            $dokan_product_data_tabs = apply_filters( 'dokan_product_data_tabs', array(
                                                ...
                                                'edit' => array(
                                                    'label'  => __( 'Edit', 'printshop' ),
                                                    'target' => 'edit-product',
                                                    'class'  => array( 'active' ),
                                                ),
                                                'options' => array(
                                                    'label'  => __( 'Options', 'printshop' ),
                                                    'target' => 'product-options',
                                                    'class'  => array(),
                                                ),
                                                'inventory' => array(
                                                    'label'  => __( 'Inventory', 'printshop' ),
                                                    'target' => 'product-inventory',
                                                    'class'  => array(),
                                                ),
                                                'shipping' => array(
                                                    'label'  => __( 'Shipping', 'printshop' ),
                                                    'target' => 'product-shipping',
                                                    'class'  => array( 'hide_if_virtual' ),
                                                ),
                                                'attributes' => array(
                                                    'label'  => __( 'Attributes', 'printshop' ),
                                                    'target' => 'product-attributes',
                                                    'class'  => array(),
                                                ),
                                                'variations' => array(
                                                    'label'  => __( 'Variations', 'printshop' ),
                                                        ...
                                                        <div class="show_if_simple">
                                                            <div class="special-price-container">
                                                                ...
                                                                <div class="dokan-form-group dokan-clearfix">
                                                                    <div class="dokan-input-group">
                                                                        <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                                        <?php dokan_post_input_box( $post_id, '_sale_price', array( 'placeholder' => __( 'Special Price', 'printshop' ) ) ); ?>
                                                                    </div>
                                                                    <a href="#" class="sale-schedule dokan-right"><?php _e( 'Schedule', 'printshop' ); ?></a>
                                                                </div>
