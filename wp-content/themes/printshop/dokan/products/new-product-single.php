...
if ( !isset( $post->ID ) && ! isset( $_GET['product_id'] ) ) {
    wp_die( __( 'Access Denied, No product found', 'printshop' ) );
}

if( isset( $post->ID ) && $post->ID && $post->post_type == 'product' ) {

    if ( $post->post_author != get_current_user_id() ) {
        wp_die( __( 'Access Denied', 'printshop' ) );
    }
            ...
            <h1 class="entry-title">
                ...
                <?php if ( $post->post_status == 'publish' ) { ?>
                    <span class="dokan-right">
                        <a class="dokan-btn dokan-btn-theme dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php _e( 'View Product', 'printshop' ); ?></a>
                    </span>
                <?php } ?>

                <?php if ( $_visibility == 'hidden' ) { ?>
                    <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="fa fa-eye-slash"></i> <?php _e( 'Hidden', 'printshop' ); ?></span>
                <?php } ?>
            </h1>
        </header><!-- .entry-header -->
        ...
        <div class="product-edit-new-container product-edit-container">
            <?php if ( Dokan_Template_Products::$errors ) { ?>
                <div class="dokan-alert dokan-alert-danger">
                    ...
                    <?php foreach ( Dokan_Template_Products::$errors as $error) { ?>
                        <strong><?php _e( 'Error!', 'printshop' ); ?></strong> <?php echo $error ?>.<br>
                    <?php } ?>
                </div>
            <?php } ?>
            ...
            <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                <div class="dokan-message">
                    ...
                    <strong><?php _e( 'Success!', 'printshop' ); ?></strong> <?php _e( 'The product has been saved successfully.', 'printshop' ); ?>

                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <a href="<?php echo get_permalink( $post_id ); ?>" target="_blank"><?php _e( 'View Product &rarr;', 'printshop' ); ?></a>
                    <?php } ?>
                </div>
            <?php } ?>
                ...
                if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                    <form class="dokan-product-edit-form" role="form" method="post">
                        ...
                        <div class="dokan-form-top-area">
                            ...
                            <div class="content-half-part dokan-product-meta">
                                ...
                                <div class="dokan-form-group">
                                    ...
                                    <label for="post_title" class="form-label"><?php _e( 'Title', 'printshop' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, 'post_title', array( 'placeholder' => __( 'Product name..', 'printshop' ), 'value' => $post_title ) ); ?>
                                    <div class="dokan-product-title-alert dokan-hide">
                                        <?php _e( 'Please enter product title!', 'printshop' ); ?>
                                    </div>
                                </div>

                                <?php if ( WeDevs_Dokan::init()->is_pro() ): ?>
                                    <div class="dokan-form-group">
                                        <label for="product_type" class="form-label"><?php _e( 'Product Type', 'printshop' ); ?> <i class="fa fa-question-circle tips" aria-hidden="true" data-title="<?php _e( 'Choose Variable if your product has multiple attributes - like sizes, colors, quality etc', 'printshop' ); ?>"></i></label>
                                        <select name="product_type" class="dokan-form-control" id="product_type">
                                            <option value="simple" <?php selected( $product_type, 'simple' ) ?>><?php _e( 'Simple', 'printshop' ) ?></option>
                                            <option value="variable" <?php selected( $product_type, 'variable' ) ?>><?php _e( 'Variable', 'printshop' ) ?></option>
                                        </select>
                                    </div>
                                <?php else: ?>
                                ...
                                <div class="dokan-form-group dokan-product-type-container show_if_simple">
                                    <div class="content-half-part downloadable-checkbox">
                                        <label>
                                            <input type="checkbox" <?php checked( $is_downloadable, true ); ?> class="_is_downloadable" name="_downloadable" id="_downloadable"> <?php _e( 'Downloadable', 'printshop' ); ?> <i class="fa fa-question-circle tips" aria-hidden="true" data-title="<?php _e( 'Downloadable products give access to a file upon purchase.', 'printshop' ); ?>"></i>
                                        </label>
                                    </div>
                                    <div class="content-half-part virtual-checkbox">
                                        <label>
                                            <input type="checkbox" <?php checked( $is_virtual, true ); ?> class="_is_virtual" name="_virtual" id="_virtual"> <?php _e( 'Virtual', 'printshop' ); ?> <i class="fa fa-question-circle tips" aria-hidden="true" data-title="<?php _e( 'Virtual products are intangible and aren\'t shipped.', 'printshop' ); ?>"></i>
                                        </label>
                                    </div>
                                    ...
                                    <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                        ...
                                        <div class="content-half-part regular-price">
                                            ...
                                            <div class="dokan-input-group">
                                                ...
                                                <?php dokan_post_input_box( $post_id, '_regular_price', array( 'placeholder' => __( '0.00', 'printshop' ) ), 'number' ); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="content-half-part sale-price">
                                            <label for="_sale_price" class="form-label">
                                                ...
                                                <a href="#" class="sale_schedule <?php echo ($show_schedule ) ? 'dokan-hide' : ''; ?>"><?php _e( 'Schedule', 'printshop' ); ?></a>
                                                <a href="#" class="cancel_sale_schedule <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>"><?php _e( 'Cancel', 'printshop' ); ?></a>
                                            </label>

                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                <?php dokan_post_input_box( $post_id, '_sale_price', array( 'placeholder' => __( '0.00', 'printshop' ) ), 'number' ); ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group">
                                        <label for="product_cat" class="form-label"><?php _e( 'Category', 'printshop' ); ?></label>
                                        <?php
                                        $product_cat = -1;
                                        $term = array();
                                    ...
                                    ?>
                                        <div class="dokan-product-cat-alert dokan-hide">
                                            <?php _e('Please choose a category!', 'printshop'); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="dokan-form-group">
                                    <label for="product_tag" class="form-label"><?php _e( 'Tags', 'printshop' ); ?></label>
                                    <?php
                            ...
                            <div class="content-half-part featured-image">
                                ...
                                <div class="dokan-product-gallery">
                                    <div class="dokan-side-body" id="dokan-product-images">
                                                ...
                                                if ( $gallery ) {
                                                    foreach ($gallery as $image_id) {
                                                        ...
                                                        <li class="image" data-attachment_id="<?php echo $image_id; ?>">
                                                            ...
                                                            <a href="#" class="action-delete" title="<?php esc_attr_e( 'Delete image', 'printshop' ); ?>">&times;</a>
                                                        </li>
                                                        <?php
                                                    }
                                                }
                                        ...
                                        <a href="#" class="add-product-images dokan-btn dokan-btn-sm dokan-btn-success"><?php _e( '+ Add more images', 'printshop' ); ?></a>
                                    </div>
                                </div> <!-- .product-gallery -->
                            </div><!-- .content-half-part -->
                        ...
                        <div class="dokan-product-short-description">
                            <label for="post_excerpt" class="form-label"><?php _e( 'Short Description', 'printshop' ); ?></label>
                        ...
                        <div class="dokan-product-description">
                            <label for="post_content" class="form-label"><?php _e( 'Description', 'printshop' ); ?></label>
                        ...
                        <div class="dokan-product-inventory dokan-edit-row">
                            <div class="dokan-section-heading" data-togglehandler="dokan_product_inventory">
                                <h2><i class="fa fa-cubes" aria-hidden="true"></i> <?php _e( 'Inventory', 'printshop' ); ?></h2>
                                <p><?php _e( 'Manage inventory for this product.', 'printshop' ); ?></p>
                            ...
                            <div class="dokan-section-content">
                                <div class="dokan-form-group hide_if_variation">
                                    <label for="_sku" class="form-label"><?php _e( 'SKU', 'printshop' ); ?> <span><?php _e( '(Stock Keeping Unit)', 'printshop' ); ?></span></label>
                                    <?php dokan_post_input_box( $post_id, '_sku' ); ?>
                                </div>

                                <div class="dokan-form-group hide_if_variation">
                                    <?php dokan_post_input_box( $post_id, '_manage_stock', array( 'label' => __( 'Enable product stock management', 'printshop' ) ), 'checkbox' ); ?>
                                </div>
                                ...
                                <div class="show_if_stock dokan-stock-management-wrapper dokan-form-group dokan-clearfix">
                                    ...
                                    <div class="dokan-w3 hide_if_variation">
                                        <label for="_stock" class="form-label"><?php _e( 'Quantity', 'printshop' ); ?></label>
                                        <input type="number" class="dokan-form-control" name="_stock" placeholder="<?php __( '1', 'printshop' ); ?>" value="<?php echo wc_stock_amount( $_stock ); ?>" min="0" step="1">
                                    </div>

                                    <div class="dokan-w3 hide_if_variation">
                                        <label for="_stock_status" class="form-label"><?php _e( 'Stock Status', 'printshop' ); ?></label>
                                    ...
                                    <div class="dokan-w3 hide_if_variation last-child">
                                        <label for="_backorders" class="form-label"><?php _e( 'Allow Backorders', 'printshop' ); ?></label>
                        ...
                        <div class="dokan-download-options dokan-edit-row dokan-clearfix show_if_downloadable">
                            <div class="dokan-section-heading" data-togglehandler="dokan_download_options">
                                <h2><i class="fa fa-download" aria-hidden="true"></i> <?php _e( 'Downloadable Options', 'printshop' ); ?></h2>
                                <p><?php _e( 'Configure your downloadable product settings', 'printshop' ); ?></p>
                                <a href="#" class="dokan-section-toggle">
                                    <i class="fa fa-sort-desc fa-flip-vertical" aria-hidden="true"></i>
                                </a>
                                <div class="dokan-clearfix"></div>
                                ...
                                <div class="dokan-divider-top dokan-clearfix">
                                    ...
                                    <div class="dokan-side-body dokan-download-wrapper">
                                        <table class="dokan-table">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><?php _e( 'Name', 'printshop' ); ?> <span class="tips" title="<?php _e( 'This is the name of the download shown to the customer.', 'printshop' ); ?>">[?]</span></th>
                                                    <th><?php _e( 'File URL', 'printshop' ); ?> <span class="tips" title="<?php _e( 'This is the URL or absolute path to the file which customers will get access to.', 'printshop' ); ?>">[?]</span></th>
                                                    <th><?php _e( 'Action', 'printshop' ); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                        ...
                                        <div class="dokan-clearfix">
                                            <div class="content-half-part">
                                                <label for="_download_limit" class="form-label"><?php _e( 'Download Limit', 'printshop' ); ?></label>
                                                <?php dokan_post_input_box( $post_id, '_download_limit', array( 'placeholder' => __( 'e.g. 4', 'printshop' ) ) ); ?>
                                            </div><!-- .content-half-part -->

                                            <div class="content-half-part">
                                                <label for="_download_expiry" class="form-label"><?php _e( 'Download Expiry', 'printshop' ); ?></label>
                                                <?php dokan_post_input_box( $post_id, '_download_expiry', array( 'placeholder' => __( 'Number of days', 'printshop' ) ) ); ?>
                                            </div><!-- .content-half-part -->
                                        </div>
                        ...
                        <?php if ( ! is_int( key( $is_enable_op_discount ) ) && array_key_exists("product-discount", $is_enable_op_discount ) == "product-discount" ) : ?>
                            <div class="dokan-discount-options dokan-edit-row dokan-clearfix">
                                <div class="dokan-section-heading" data-togglehandler="dokan_discount_options">
                                    <h2><i class="fa fa-gift"></i> <?php _e( 'Discount Options', 'printshop' ); ?></h2>
                                ...
                                <div class="dokan-section-content">
                                    <label class="dokan-form-label" for="_is_lot_discount">
                                        ...
                                        <?php _e( 'Enable bulk discount', 'printshop' ); ?>
                                    </label>

                                    <div class="show_if_needs_lot_discount <?php echo ( $_is_lot_discount=='yes') ? '' : 'dokan-hide'; ?>">
                                        <div class="content-half-part">
                                            <label class="dokan-form-label" for="_lot_discount_quantity"><?php _e('Minimum quantity', 'printshop');?></label>
                                            <?php dokan_post_input_box( $post_id, '_lot_discount_quantity', array( 'class'=>'dokan-form-control', 'placeholder' => __( '0', 'printshop' ), 'min' => 0, 'value' => $_lot_discount_quantity ), 'number' ); ?>
                                        </div>
                                        <div class="dokan-form-group content-half-part">
                                            <label class="dokan-form-label" for="_lot_discount_amount"><?php _e('Discount %', 'printshop');?></label>
                                            <div class="dokan-input-group">
                                                <input id="_lot_discount_amount" value="<?php echo $_lot_discount_amount; ?>" name="_lot_discount_amount" placeholder="<?php _e( 'Percentage', 'printshop' ); ?>" class="dokan-form-control" type="number" min="0" max="100">
                        ...
                        <div class="dokan-other-options dokan-edit-row dokan-clearfix">
                            <div class="dokan-section-heading" data-togglehandler="dokan_other_options">
                                <h2><i class="fa fa-cog" aria-hidden="true"></i> <?php _e( 'Other Options', 'printshop' ); ?></h2>
                                <p><?php _e( 'Set your extra product options', 'printshop' ); ?></p>
                                <a href="#" class="dokan-section-toggle">
                                    <i class="fa fa-sort-desc fa-flip-vertical" aria-hidden="true"></i>
                                </a>
                                <div class="dokan-clearfix"></div>
                            ...
                            <div class="dokan-section-content">
                                <div class="dokan-form-group content-half-part">
                                    <label for="post_status" class="form-label"><?php _e( 'Product Status', 'printshop' ); ?></label>
                                    <?php if ( $post_status != 'pending' ) { ?>
                                        <?php $post_statuses = apply_filters( 'dokan_post_status', array(
                                            'publish' => __( 'Online', 'printshop' ),
                                            'draft'   => __( 'Draft', 'printshop' )
                                        ), $post ); ?>
                                ...
                                <div class="dokan-form-group content-half-part">
                                    <label for="_visibility" class="form-label"><?php _e( 'Visibility', 'printshop' ); ?></label>
                                ...
                                <div class="dokan-form-group">
                                    <label for="_purchase_note" class="form-label"><?php _e( 'Purchase Note', 'printshop' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, '_purchase_note', array( 'placeholder' => __( 'Customer will get this info in their order email', 'printshop' ) ), 'textarea' ); ?>
                                </div>

                                <div class="dokan-form-group">
                                    <?php $_enable_reviews = ( $post->comment_status == 'open' ) ? 'yes' : 'no'; ?>
                                    <?php dokan_post_input_box( $post_id, '_enable_reviews', array('value' => $_enable_reviews, 'label' => __( 'Enable product reviews', 'printshop' ) ), 'checkbox' ); ?>
                                </div>
                        ...
                        <input type="hidden" name="dokan_update_product" value="<?php esc_attr_e( 'Save Product', 'printshop' ); ?>"/>
                        <input type="submit" name="dokan_update_product" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'Save Product', 'printshop' ); ?>"/>
                        <div class="dokan-clearfix"></div>
                    </form>
                <?php } else { ?>
