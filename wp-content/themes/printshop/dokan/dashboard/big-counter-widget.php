...
<div class="dashboard-widget big-counter">
    <ul class="list-inline">
         <li>
            <div class="title"><?php _e( 'Sales', 'printshop' ); ?></div>
            <div class="count"><?php echo wc_price( $earning ); ?></div>
        </li>
        <li>
            <div class="title"><?php _e( 'Earning', 'printshop' ); ?></div>
            <div class="count"><?php echo $seller_balance; ?></div>
        </li>
        <li>
            <div class="title"><?php _e( 'Pageview', 'printshop' ); ?></div>
            <div class="count"><?php echo dokan_number_format( $pageviews ); ?></div>
        </li>
        <li>
            <div class="title"><?php _e( 'Order', 'printshop' ); ?></div>
            <div class="count">
                <?php
